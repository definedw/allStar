...
$.dialog = {
    config: {
        ...
        openClass: 'open',
        frag: '<div id="dialog" class="pop-window unitBox"><div class="pop-header"><span class="title">弹出框</span><a class="pop-down-close" href="javascript:$.dialog.close()"><i class="icon icon-close"></i></a></div><div class="pop-content"></div></div>',
